...
public static class RuntimeComponentCopier
{
    ...
    public static T GetCopyOfv2<T>(this MonoBehaviour Monobehaviour, T Source) where T : MonoBehaviour
    {
        //Type check
    ...
    public static T AddComponentCopied<T>(this GameObject go, T toAdd) where T : Component
    {
